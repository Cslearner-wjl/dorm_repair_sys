...
**Evidence**
- source visual truth path: `docs/design/prototypes/ChatGPT Image 2026年6月28日 21_26_39 (2).png`
...
- implementation screenshot path: `docs/screenshots/student-home-desktop.png`
